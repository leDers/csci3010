...
#include <memory>
#include "../../hw4_chutesAndLadders/setupdialog.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SetupDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SetupDialog_t qt_meta_stringdata_SetupDialog = {
    {
        QT_MOC_LITERAL(0, 11),  // "SetupDialog"
        QT_MOC_LITERAL(12, 21),  // "onSpinBoxValueChanged"
        QT_MOC_LITERAL(34, 0),  // ""
        QT_MOC_LITERAL(35, 5),  // "value"
        QT_MOC_LITERAL(41, 12)   // "saveAndClose"
    },
    "SetupDialog",
...
Q_CONSTINIT static const uint qt_meta_data_SetupDialog[] = {
...
Q_CONSTINIT const QMetaObject SetupDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_SetupDialog.offsetsAndSizes,
    qt_meta_data_SetupDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SetupDialog_t,
        // Q_OBJECT / Q_GADGET
