...
int main(){
    ...
    int int_val= 3;
    Compare<int, std::vector<int>> int_Compare(int_vec);
    ...
    double dbl_val= 0.35;
    Compare<double, std::vector<double>> dbl_Compare(dbl_vec);
    ...
    char char_val= 'd';
    Compare<char, std::vector<char>> char_Compare(char_vec);
    ...
    Compare<myClass, std::vector<myClass>> myClass_Compare(myClass_vec);
    ...
    std::cout << "\ncmyClass -- less than: "<< myClass_val << std::endl;
    for ( auto i : myClass_less){
        std::cout << i << " ";
    } std::cout << std::endl;

    // greater than calls --- --- ---
    std::cout << "\ngetGreaterThan() calls..." << std::endl;
    ...
    // matches calls --- --- ---
    std::cout << "\nmatches() calls..." << std::endl;

    std::cout << "\nint -- number matches for: "<< int_val << std::endl;
    std::cout << int_matches << std::endl; 

    std::cout << "\ndouble -- number matches for: "<< dbl_val << std::endl;
    std::cout << dbl_matches << std::endl; 

    std::cout << "\nchar -- matches matches for: "<< char_val << std::endl;
    std::cout << char_matches << std::endl; 

    std::cout << "\nmyClass -- matches matches for: "<< myClass_val << std::endl;
    std::cout << myClass_matches << std::endl;     
